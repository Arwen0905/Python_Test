# 1. 題目說明:
# 請開啟PYD506.py檔案，依下列題意進行作答，
# 依使用者輸入的數字作為參數傳遞進行公式計算，使輸出值符合題意要求。
# 作答完成請另存新檔為PYA506.py再進行評分。

# 2. 設計說明：
# 請撰寫一程式，將使用者輸入的三個整數
# （代表一元二次方程式 ax2+bx+c=0的三個係數a、b、c 的三個係數a、b、c）
