# 1. 題目說明:
# 請開啟PYD202.py檔案，依下列題意進行作答，
# 判斷輸入值是否為3或5的倍數，使輸出值符合題意要求。
# 作答完成請另存新檔為PYA202.py再進行評分。

# 2. 設計說明：
# 請使用選擇敘述撰寫一程式，讓使用者輸入一個正整數，
# 然後判斷它是3或5的倍數，顯示【x is a multiple of 3.】或
# 【x is a multiple of 5.】；若此數值同時為3與5的倍數，
# 顯示【x is a multiple of 3 and 5.】；如此數值皆不屬於3或5的倍數，
